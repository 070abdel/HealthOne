...
class Model
{
    ...
    public function getPatienten(){
        ...
        if($selection){
            $result=$selection->fetchAll(\PDO::FETCH_CLASS, Patient::class);
            return $result;
        }
        return null;
    }
    public function selectPatient($id){
        ...
        if($result){
            $selection->setFetchMode(\PDO::FETCH_CLASS, Patient::class);
